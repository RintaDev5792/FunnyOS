...
function saveConfig()
    ...
    datastore["drawIconBorders"] = drawIconBorders
...
function loadConfig()
    ...
    if datastore then
        ...
        drawIconBorders = datastore["drawIconBorders"]
    ...
    if drawIconBorders == nil then drawIconBorders = true end
    if #labels < 1 then
...
function main()
    ...
    menu:addCheckmarkMenuItem("borders", drawIconBorders, function(bool) 
        drawIconBorders = bool 
    ...
    menu:addCheckmarkMenuItem("organize", false, function(bool) organizeMode = bool reloadIconsNextFrame = true drawerOpen = false end)
end
...
function setupGameInfo()
    ...
    gfx.setDitherPattern(0.75,gfx.image.kDitherTypeScreen)
