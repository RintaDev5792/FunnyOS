-- NOTE: modified slightly to work better with playdate sdk
...
function zzlib_inflate_bwo.band(x,y) return x & y end
function zzlib_inflate_bwo.rshift(x,y) return x >> y end

function zzlib_inflate_bwo.bitstream_init(file)
  local bs = {
...
function zzlib_inflate_bwo.main(bs)
  local last,type
  local output = {}
  repeat
    local block
...
local crc32_table
function zzlib_inflate_bwo.crc32(s,crc)
